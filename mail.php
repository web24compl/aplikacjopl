...
try {
    ...
    $smtpUsername = 'no-reply@mbappe.pl';
    $smtpPassword = 'QBlv49pGL';
    $emailFrom = $smtpUsername;
    $emailFromName = 'Formularz mbappe.pl';
    $emailTo = 'biuro@mbappe.pl';
    ...
    $mail->Subject = 'mbappe - Zapytanie od: ' . $formData['company'];
